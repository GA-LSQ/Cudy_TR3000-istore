...
sed -i 's/immortalwrt/Cudy/g' package/base-files/luci2/bin/config_generate
sed -i 's/immortalwrt/Cudy/g' package/lean/default-settings/files/zzz-default-settings
